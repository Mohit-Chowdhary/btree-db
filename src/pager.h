...
#define DEBUG_COUT if (g_debug_mode) std::cout


const int CACHE_CAPACITY = 10000; // max pages resident in memory at once
...
struct Pager {
    ...
    std::map<int, std::list<int>> freq_list;  // freq -> MRU-first list of page_nums
